...
const TeamsTable = () => {
    ...
    const handleUpdateTeam = async (e: React.FormEvent) => {
      ...
      try {
        ...
        setUpdateIsOpen(false);
          ...
          console.error("Erro ao adicionar equipe! Tente novamente...");
      } finally {
        setIsLoading(false);
      }
    };
    ...
    const handleRemoveTeam = async (e: React.FormEvent) => {
      ...
      try {
        ...
        console.log("Erro ao excluir equipe! Tente novamente...");
    ...
    <Card className='min-h-[70vh] flex flex-col'>
      <CardHeader>
        <CardTitle className='text-2xl'>Equipes</CardTitle>
      </CardHeader>
      ...
      {isInitialLoading ? ( 
        ...
        ): (<NotFound name='Nenhuma equipe encontrada.'/>)}
        <Pagination name="equipes" filterPage={filterPage} totalUsersPage={totalTeamsPage} />
